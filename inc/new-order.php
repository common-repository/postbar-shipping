...
function postbar_new_and_tracking_order_metabox_HTML( $post )
{
    ...
    $postbarTrackingResult = is_numeric($postbar_orderId) ? Postbar_API::orderTracking( $postbar_orderId ) : '';
        ...
        <div id="pshot-body">
            ...
            <div>
                ...
                <div class="postex-mt-15">
                    <a class="postex-pdf-btn" href='<?php echo site_url(); ?>/wp-content/plugins/postbar-shipping/inc/orederInvoice.php?orderid=<?php echo $postbar_orderId; ?>&token=<?php echo Postbar_API::getToken(); ?>' target='_blank'>
                        دریافت فاکتور
                    </a>
                </div>
            </div>
    ...
    <div id="postex_order_details_container">
        <table class="pws-wide-form-table">
            ...
            <tr id="CodGoodsPrice_row">
                <th>
                    <label for="CodGoodsPrice">مبلغ كالا در مرسولات پس كرايه (ریال)</label>                                
                </th>
                <td>
                    <input type="text" name="CodGoodsPrice" id="CodGoodsPrice" value="<?php echo $CodGoodsPrice;  ?>" />
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td>
                    <div id='admin_services_content_container'></div>
                </td>
            </tr>        
            <tr>
                <th>
    ...
    <img id="postbar_shipping_loading" src="<?php echo PostbarShipping::plugin_url().'/assets/images/loadspinner.gif' ?>" />

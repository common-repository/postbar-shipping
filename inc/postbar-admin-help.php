                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="img-wrapper">
                            <img src="<?php echo PostbarShipping::plugin_url().'/assets/images/shipping-banner-1.png' ?>" alt="حمل و نقل پستِکس">
                        </div>
                    </div>                
                </div>            
            </div>            
        ...
        <div id="postbar-hpl-settings">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="img-wrapper">
                            <img src="<?php echo PostbarShipping::plugin_url().'/assets/images/help-img-1-1.png' ?>" alt="منو">
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="img-wrapper">
                            <img src="<?php echo PostbarShipping::plugin_url().'/assets/images/help-img-2-1.png' ?>" alt="لاگین">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="img-wrapper">
                            <img src="<?php echo PostbarShipping::plugin_url().'/assets/images/help-img-3.png' ?>" alt="سایر تنظیمات">
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="img-wrapper">
                            <img src="<?php echo PostbarShipping::plugin_url().'/assets/images/help-img-4-1.png' ?>" alt="فعال کردن محاسبه گر حمل و نقل در سبد خرید">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="img-wrapper">
                            <img src="<?php echo PostbarShipping::plugin_url().'/assets/images/help-img-5-1.png' ?>" alt="فعال کردن محاسبه گر حمل و نقل در سبد خرید">
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="img-wrapper">
                            <img src="<?php echo PostbarShipping::plugin_url().'/assets/images/help-img-6-1.png' ?>" alt="فعال کردن پستِکس">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="img-wrapper">
                            <img src="<?php echo PostbarShipping::plugin_url().'/assets/images/help-img-7-1.png' ?>" alt="ارسال سفارش برای باربری">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="setting-info">
        ...
        <div id="postbar-hpl-about">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="img-wrapper">
                            <img src="<?php echo PostbarShipping::plugin_url().'/assets/images/help-about-1.png' ?>" alt="درباره ما">
                        </div>
                    </div>
                    <div class="col-md-6">
